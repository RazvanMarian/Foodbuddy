                            ...
                            <Card key={item._id}>
                                <div id="avatar-holder">
                                    <img id="post-avatar" src={item.postedBy.photo} alt="Avatar" />{
                                        state ?
                                            ...
                                            : <p id="post-owner">{item.postedBy.lastName + " " + item.postedBy.firstName}</p>
                                    }
                                </div >
                                ...
                                <Card.Body>
                                    ...
                                    {state ?
                                        ...
                                        :
                                        <p id="card-like"><Button className="postBtn" >{item.likes.length} likes</Button>
                                            <Button className="postBtn" onClick={() => handleShow(item._id)}>See the recipe</Button></p>
                                    }
                                    <div>
